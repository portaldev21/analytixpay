...
|----------|-------|--------|------------|
| Finance/Banking | Minimal, professional | Blue, green, dark | Letter, shield, chart. ControleFatura uses Verde Esmeralda (#2C8A4B) + Azul Medio (#1D5A8F) with Merriweather/Inter/Roboto Mono fonts |
